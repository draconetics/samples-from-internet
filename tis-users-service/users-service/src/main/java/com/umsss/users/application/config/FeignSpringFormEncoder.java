...
public class FeignSpringFormEncoder implements Encoder {
    ...
    private static Logger LOG = LoggerFactory.getLogger(FeignSpringFormEncoder.class);
    ...
    private HttpEntity<?> encodeMultipartFile(MultipartFile file) {
        ...
        try {
            ...
            // TODO: This define always octet stream contentType for all upload files, review when contentType is required to define.
            // return new HttpEntity<>(multipartFileResource, filePartHeaders);
            return new HttpEntity<>(multipartFileResource);
    ...
    private void encodeMultipartFiles(LinkedMultiValueMap<String, Object> map, String name, List<? extends MultipartFile> files) {
        ...
        try {
            for (MultipartFile file : files) {
                ...
                map.add(name, new HttpEntity<>(multipartFileResource));
            }
        } catch (IOException ex) {
            throw new EncodeException("Cannot encode request.", ex);
        }
